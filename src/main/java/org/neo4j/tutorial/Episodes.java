...
public class Episodes {
    ...
    public void insert() {
        ...
        try {
            ...
            season25();
            season26();
            episode(156).title("Doctor Who").doctor("Paul McGann").doctor("Sylvester McCoy").companion("Grace Holloway").enemy("Master").fact(db);
            series01();
            episode(167).title("The Christmas Invasion").doctor("David Tennant").companion("Rose Tyler").enemySpecies("Sycorax").fact(db);
            series02();
            episode(178).title("The Runaway Bride").doctor("David Tennant").companion("Donna Noble").enemy("Empress of Racnoss").fact(db);
            series03();
            episode(188).title("Voyage of the Damned").doctor("David Tennant").companion("Astrid Peth").fact(db);
            series04();
            series05();
            episode(213).title("A Christmas Carol").doctor("Matt Smith").companion("Amy Pond", "Rory Williams").enemy("Kazran Sardick").fact(db);
            series06();
    ...
    private void series06() {
        episode(214).title("The Impossible Astronaut").doctor("Matt Smith").companion("Amy Pond", "Rory Williams", "River Song").allies("Richard Nixon", "Canton Everett Delaware III").enemySpecies("The Silents").fact(db);
        episode(214).title("Day of the Moon").doctor("Matt Smith").companion("Amy Pond", "Rory Williams", "River Song").enemySpecies("The Silents").fact(db);
    }
    ...
    private void series05() {
        ...
        episode(203).title("The Eleventh Hour").doctor("Matt Smith").companion("Amy Pond").enemy("Prisoner Zero").fact(db);
        episode(204).title("The Beast Below").doctor("Matt Smith").companion("Amy Pond").enemy("Prisoner Zero").fact(db);
        episode(206).title("Victory of the Daleks").doctor("Matt Smith").companion("Amy Pond").enemySpecies("Dalek").fact(db);
        episode(206).title("The Time of Angels").doctor("Matt Smith").companion("Amy Pond").enemySpecies("Weeping Angel").fact(db);
        episode(206).title("Flesh and Stone").doctor("Matt Smith").companion("Amy Pond").enemySpecies("Weeping Angel").fact(db);
        episode(207).title("The Vampires of Venice").doctor("Matt Smith").companion("Amy Pond").enemy("Signora Calvierri").fact(db);
        episode(208).title("Amy's Choice").doctor("Matt Smith").companion("Amy Pond", "Rory Williams").enemySpecies("Eknodine").fact(db);
        episode(209).title("The Hungry Earth").doctor("Matt Smith").companion("Amy Pond", "Rory Williams").enemySpecies("Silurian").fact(db);
    ...
    private void series04() {
        episode(189).title("Partners in Crime").doctor("David Tennant").companion("Donna Noble").enemy("Miss Foster").fact(db);
        episode(190).title("The Fires of Pompeii").doctor("David Tennant").companion("Donna Noble").enemy("Pyrovile").fact(db);
        episode(191).title("Planet of the Ood").doctor("David Tennant").companion("Donna Noble").fact(db);
        episode(192).title("The Sontaran Stratagem").doctor("David Tennant").companion("Donna Noble", "Martha Jones").enemy("General Staal").fact(db);
        episode(192).title("The Poison Sky").doctor("David Tennant").companion("Donna Noble", "Martha Jones").enemy("General Staal").fact(db);
        episode(193).title("The Doctor's Daughter").doctor("David Tennant").companion("Donna Noble", "Martha Jones").enemy("General Cobb").fact(db);
        episode(194).title("The Unicorn and the Wasp").doctor("David Tennant").companion("Donna Noble").fact(db);
        episode(195).title("Silence in the Library").doctor("David Tennant").companion("Donna Noble").enemySpecies("Vashta Nerada").fact(db);
    ...
    private void series03() {
        episode(179).title("Smith and Jones").doctor("David Tennant").companion("Martha Jones").enemySpecies("Plasmavore").fact(db);
        episode(180).title("The Shakespeare Code").doctor("David Tennant").companion("Martha Jones").enemySpecies("Carrionite").fact(db);
        episode(181).title("Gridlock").doctor("David Tennant").companion("Martha Jones").enemySpecies("Macra").fact(db);
        episode(182).title("Daleks in Manhattan").doctor("David Tennant").companion("Martha Jones").enemySpecies("Dalek").fact(db);
        episode(182).title("Evolution of the Daleks").doctor("David Tennant").companion("Martha Jones").enemySpecies("Dalek").fact(db);
        episode(183).title("The Lazarus Experiment").doctor("David Tennant").companion("Martha Jones").enemy("Lazarus").fact(db);
        episode(184).title("42").doctor("David Tennant").companion("Martha Jones").fact(db);
        episode(185).title("Human Nature").doctor("David Tennant").companion("Martha Jones").enemy("Family of Blood").fact(db);
        episode(185).title("Family of Blood").doctor("David Tennant").companion("Martha Jones").enemy("Family of Blood").fact(db);
        episode(186).title("Blink").doctor("David Tennant").companion("Martha Jones").enemySpecies("Weeping Angel").fact(db);
        episode(187).title("Utopia").doctor("David Tennant").companion("Martha Jones", "Jack Harkness").enemy("Master").fact(db);
        episode(187).title("The Sound of Drums").doctor("David Tennant").companion("Martha Jones", "Jack Harkness").enemy("Master").fact(db);
        episode(187).title("Last of the Time Lords").doctor("David Tennant").companion("Martha Jones", "Jack Harkness").enemy("Master").fact(db);
    }
    ...
    private void series02() {
        ...
        episode(174).title("The Impossible Planet").doctor("David Tennant").companion("Rose Tyler").enemy("Beast").fact(db);
        episode(174).title("The Satan Pit").doctor("David Tennant").companion("Rose Tyler").enemy("Beast").fact(db);
        episode(175).title("Love & Monsters").doctor("David Tennant").companion("Rose Tyler").enemy("Abzorbaloff").fact(db);
        episode(176).title("Fear Her").doctor("David Tennant").companion("Rose Tyler").fact(db);
        episode(177).title("Army of Ghosts").doctor("David Tennant").companion("Rose Tyler").enemySpecies("Cyberman", "Dalek").fact(db);
        episode(177).title("Doomsday").doctor("David Tennant").companion("Rose Tyler").enemySpecies("Cyberman", "Dalek").fact(db);
    }

    private void series01() {
        episode(157).title("Rose").doctor("Christopher Eccleston").companion("Rose Tyler").enemySpecies("Auton").fact(db);
        episode(158).title("The End of the World").doctor("Christopher Eccleston").companion("Rose Tyler").enemy("Cassandra").fact(db);
        episode(159).title("The Unquiet Dead").doctor("Christopher Eccleston").companion("Rose Tyler").enemy("Gabriel Sneed").fact(db);
        episode(160).title("Aliens of London").doctor("Christopher Eccleston").companion("Rose Tyler").enemySpecies("Slitheen").fact(db);
        episode(160).title("World War Three").doctor("Christopher Eccleston").companion("Rose Tyler").enemySpecies("Slitheen").fact(db);
        episode(161).title("Dalek").doctor("Christopher Eccleston").companion("Rose Tyler").enemySpecies("Dalek").fact(db);
        episode(162).title("The Long Game").doctor("Christopher Eccleston").enemy("The Editor").companion("Rose Tyler").fact(db);
        episode(163).title("Father's Day").doctor("Christopher Eccleston").companion("Rose Tyler").fact(db);
        episode(164).title("The Empty Child").doctor("Christopher Eccleston").companion("Rose Tyler", "Jack Harkness").fact(db);
    ...
    private void season26() {
        episode(151).title("Battlefield").doctor("Sylvester McCoy").companion("Ace").fact(db);
        episode(152).title("Ghost Light").doctor("Sylvester McCoy").companion("Ace").enemy("Josiah Samuel Smith").fact(db);
        episode(153).title("The Curse of Fenric").doctor("Sylvester McCoy").companion("Ace").enemy("Fenric").fact(db);
        episode(154).title("Survival").doctor("Sylvester McCoy").companion("Ace").enemy("Master").fact(db);
    }

    private void season25() {
        episode(148).title("Remembrance of the Daleks").doctor("Sylvester McCoy").companion("Ace").enemy("Davros").enemySpecies("Dalek").fact(db);
        episode(149).title("The Happiness Patrol").doctor("Sylvester McCoy").companion("Ace").enemy("Helen A").fact(db);
        episode(150).title("Silver Nemesis").doctor("Sylvester McCoy").companion("Ace").enemySpecies("Cyberman").fact(db);
        episode(151).title("The Greatest Show in the Galaxy").doctor("Sylvester McCoy").companion("Ace").fact(db);
    }

    private void season24() {
        episode(144).title("Time and the Rani").doctor("Colin Baker").doctor("Sylvester McCoy").companion("Melanie Bush").enemy("Rani").fact(db);
        episode(145).title("Paradise Towers").doctor("Sylvester McCoy").companion("Melanie Bush").enemy("Kroagnon").fact(db);
        episode(146).title("Delta and the Bannermen").doctor("Sylvester McCoy").companion("Melanie Bush").enemy("Gavrok").fact(db);
        episode(147).title("Dragonfire").doctor("Sylvester McCoy").companion("Melanie Bush", "Ace").enemy("Kane").fact(db);
    }

    private void season23() {
        episode(143).title("The Mysterious Planet").doctor("Colin Baker").companion("Peri Brown").fact(db);
        episode(143).title("Mindwarp").doctor("Colin Baker").companion("Peri Brown").fact(db);
        episode(143).title("Terror of the Vervoids").doctor("Colin Baker").companion("Melanie Bush").fact(db);
        episode(143).title("The Ultimate Foe").doctor("Colin Baker").companion("Melanie Bush").enemy("Master").fact(db);
    }

    private void season22() {
        episode(136).title("The Twin Dilemma").doctor("Colin Baker").companion("Peri Brown").fact(db);
    ...
    private void season21() {
        ...
        episode(134).title("Planet of Fire").doctor("Peter Davison").companion("Tegan Jovanka", "Vislor Turlough", "Peri Brown").enemy("Master").fact(db);
        episode(135).title("The Caves of Androzani").doctor("Peter Davison").doctor("Colin Baker").companion("Peri Brown").enemy("Master").fact(db);
    }
    ...
    private void season18() {
        episode(109).title("The Leisure Hive").doctor("Tom Baker").companion("Romana", "K9").fact(db);
        episode(110).title("Meglos").doctor("Tom Baker").companion("Romana", "K9").enemy("Meglos").fact(db);
        episode(111).title("Full Circle").doctor("Tom Baker").companion("Romana", "K9", "Adric").enemySpecies("Marshman").fact(db);
    ...
    private void season17() {
        episode(104).title("Destiny of the Daleks").doctor("Tom Baker").companion("Romana").enemySpecies("Dalek").fact(db);
        episode(105).title("City of Death").doctor("Tom Baker").companion("Romana").enemy("Scaroth").fact(db);
        episode(106).title("The Creature from the Pit").doctor("Tom Baker").companion("Romana", "K9").enemy("Erato", "Lady Adrasta").fact(db);
        episode(107).title("Nightmare of Eden").doctor("Tom Baker").companion("Romana", "K9").enemySpecies("Mandrel").fact(db);
        episode(108).title("The Horns of Nimon").doctor("Tom Baker").companion("Romana", "K9").enemySpecies("Nimon").fact(db);
    }

    private void season16() {
        episode(98).title("The Ribos Operation").doctor("Tom Baker").companion("Romana", "K9").enemy("Graff Vynda-K", "Black Guardian").fact(db);
        episode(99).title("The Pirate Planet").doctor("Tom Baker").companion("Romana", "K9").enemy("Pirate Captain").fact(db);
        episode(100).title("The Stones of Blood").doctor("Tom Baker").companion("Romana", "K9").enemy("de Vries").enemySpecies("Ogri").fact(db);
        episode(101).title("The Androids of Tara").doctor("Tom Baker").companion("Romana", "K9").enemy("Count Grendel of Gracht").fact(db);
        episode(102).title("The Power of Kroll").doctor("Tom Baker").companion("Romana").enemy("Kroll").fact(db);
        episode(103).title("The Armageddon Factor").doctor("Tom Baker").companion("Romana", "K9").enemy("The Shadow", "Black Guardian").fact(db);
    }

    private void season15() {
        episode(92).title("Horror of Fang Rock").doctor("Tom Baker").companion("Leela").fact(db);
        episode(93).title("The Invisible Enemy").doctor("Tom Baker").companion("Leela", "K9").enemy("Nucleus").fact(db);
        episode(94).title("Image of the Fendahl").doctor("Tom Baker").companion("Leela").enemy("Fendahl").fact(db);
        episode(95).title("The Sun Makers").doctor("Tom Baker").companion("Leela", "K9").enemy("Collector").fact(db);
        episode(96).title("Underworld").doctor("Tom Baker").companion("Leela", "K9").enemy("Oracle").fact(db);
        episode(97).title("The Invasion of Time").doctor("Tom Baker").companion("Leela", "K9").enemySpecies("Sontaran").enemy("Stor").fact(db);
    }

    private void season14() {
        episode(86).title("The Masque of Mandragora").doctor("Tom Baker").companion("Sarah Jane Smith").enemy("Count Federico", "Captain Rossini").fact(db);
        episode(87).title("The Hand of Fear").doctor("Tom Baker").companion("Sarah Jane Smith").enemy("Eldrad").fact(db);
        episode(88).title("The Deadly Assassin").doctor("Tom Baker").enemy("Master").fact(db);
        episode(89).title("The Face of Evil").doctor("Tom Baker").companion("Leela").enemy("Xoanon").fact(db);
        episode(90).title("The Robots of Death").doctor("Tom Baker").companion("Leela").fact(db);
        episode(91).title("The Talons of Weng-Chiang").doctor("Tom Baker").companion("Leela").enemy("Li H'sen Chang").fact(db);
    }
    ...
    private void season13() {
        ...
        episode(84).title("The Brain of Morbius").doctor("Tom Baker").companion("Sarah Jane Smith").enemy("Morbius", "Doctor Solon").fact(db);
        episode(85).title("The Seeds of Doom").doctor("Tom Baker").companion("Sarah Jane Smith").enemy("Harrison Chase").fact(db);
    }
    ...
    private void season11() {
        episode(70).title("The Time Warrior").doctor("Jon Pertwee").companion("Sarah Jane Smith").enemy("Linx").fact(db);
        episode(71).title("Invasion of the Dinosaurs").doctor("Jon Pertwee").companion("Sarah Jane Smith").fact(db);
        episode(72).title("Death to the Daleks").doctor("Jon Pertwee").companion("Sarah Jane Smith").enemySpecies("Dalek").fact(db);
        episode(73).title("The Monster of Peladon").doctor("Jon Pertwee").companion("Sarah Jane Smith").enemy("Chancellor Ortron").fact(db);
        episode(74).title("Planet of the Spiders").doctor("Jon Pertwee").doctor("Tom Baker").companion("Sarah Jane Smith").fact(db);
    }
    ...
    private void season09() {
        ...
        episode(64).title("The Time Monster").doctor("Jon Pertwee").enemy("Master").companion("Jo Grant").fact(db);
    }

    private void season08() {
        episode(55).title("Terror of the Autons").doctor("Jon Pertwee").companion("Jo Grant").enemy("Master").enemySpecies("Auton").fact(db);
        episode(56).title("The Mind of Evil").doctor("Jon Pertwee").companion("Jo Grant").enemy("Master").fact(db);
        episode(57).title("The Claws of Axos").doctor("Jon Pertwee").companion("Jo Grant").enemy("Master").enemySpecies("Axon").fact(db);
        episode(58).title("Colony in Space").doctor("Jon Pertwee").companion("Jo Grant").enemy("Master").fact(db);
        episode(59).title("The Daemons").doctor("Jon Pertwee").companion("Jo Grant").enemy("Bok", "Master").fact(db);
    }

    private void season07() {
        episode(51).title("Spearhead from Space").doctor("Jon Pertwee").companion("Liz Shaw").enemySpecies("Auton").fact(db);
        episode(52).title("Doctor Who and the Silurians").doctor("Jon Pertwee").companion("Liz Shaw").enemySpecies("Silurian").fact(db);
        episode(53).title("The Ambassadors of Death").doctor("Jon Pertwee").companion("Liz Shaw").enemy("Reegan").fact(db);
        episode(54).title("Inferno").doctor("Jon Pertwee").companion("Liz Shaw").fact(db);
    }

    private void season06() {
        episode(44).title("The Dominators").doctor("Patrick Troughton").companion("Jamie McCrimmon", "Zoe Heriot").enemySpecies("Dominator", "Quark").fact(db);
        episode(45).title("The Mind Robber").doctor("Patrick Troughton").companion("Jamie McCrimmon", "Zoe Heriot").enemy("Master").fact(db);
        episode(46).title("The Invasion").doctor("Patrick Troughton").companion("Jamie McCrimmon", "Zoe Heriot").fact(db);
    ...
    private void season03() {
        ...
        episode(27).title("The War Machines").doctor("William Hartnell").companion("Dodo Chaplet", "Steven Taylor", "Polly").enemy("WOTAN").fact(db);
        episode(28).title("The Smugglers").doctor("William Hartnell").companion("Polly", "Ben Jackson").fact(db);
        episode(29).title("The Tenth Planet").doctor("William Hartnell").doctor("Patrick Troughton").companion("Polly", "Ben Jackson").fact(db);
    }
