...
public class Koan11
{
    ...
    public void shouldCountTheEnemiesOfTheDoctor() throws Exception
    {
        ...
        WebResource resource = client.resource( universe.theDoctor()
                .get( "incoming_relationships" ) + "/ENEMY_OF" );
    ...
    public void canAddFirstAndSecondIncarnationInformationForTheDoctor()
    {
        ...
        String theDoctorUri = theDoctorJson.get( "self" )
                .toString();

        Map<String, Object> williamHartnellJson = universe.getJsonFor( universe.getUriFromIndex( "actors", "actor",
                "William Hartnell" ) );
        Map<String, Object> richardHurdnallJson = universe.getJsonFor( universe.getUriFromIndex( "actors", "actor",
                "Richard Hurdnall" ) );
        Map<String, Object> patrickTroughtonJson = universe.getJsonFor( universe.getUriFromIndex( "actors", "actor",
                "Patrick Troughton" ) );
        ...
        cmds.createNode( 0, MapUtil.stringMap( "incarnation", "First Doctor" ) )
                ...
                .createRelationship( williamHartnellJson.get( "create_relationship" )
                        .toString(), "{0}", PLAYED )
                .createRelationship( richardHurdnallJson.get( "create_relationship" )
                        .toString(), "{0}", PLAYED )
                .createRelationship( patrickTroughtonJson.get( "create_relationship" )
                        .toString(), "{1}", PLAYED );
        ...
        assertFirstAndSecondDoctorCreatedAndLinkedToActors( universe.getServer()
                .getDatabase().graph );
    ...
    private void assertActorsAndInvasionEpisodes( EpisodeSearchResults results )
    {
        ...
        Map<String, String> episodesAndActors = MapUtil.stringMap( "The Christmas Invasion", "David Tennant",
                "The Invasion of Time", "Tom Baker", "The Android Invasion", "Tom Baker", "Invasion of the Dinosaurs",
                "Jon Pertwee", "The Invasion", "Patrick Troughton", "The Dalek Invasion of Earth", "William Hartnell" );
        ...
        assertEquals( episodesAndActors.keySet()
                .size(), count );
    }
